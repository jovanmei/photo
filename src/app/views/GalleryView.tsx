...
export const GalleryView = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F2F2F2] text-black font-sans flex flex-col p-8 md:p-12 relative overflow-hidden">
      {/* Top Navigation */}
      <header className="flex justify-between items-start w-full relative z-20 mb-8">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="flex items-center gap-12 md:gap-24">
          <button 
            ...
            className="text-[10px] font-black tracking-[0.3em] uppercase hover:opacity-50 transition-opacity whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-black/20 px-2 py-1"
          >
            [ Prev ]
          </button>
